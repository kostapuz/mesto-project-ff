import { cardTemplate, renderLoading } from "../pages";
import { deleteCardFromServer } from "./api";
export { createCard, deleteCard, renderLoading };

// @todo: Функция создания карточки
function createCard(data, prepareDeleteCard, toFullImage, changeLike, userId) {
  ...
  if (isOwner) {
    ...
    cardDeleteButton.addEventListener("click", () => prepareDeleteCard(card));
  }
